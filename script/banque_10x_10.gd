...
func _on_area_banque_10_piasse_body_entered(_body: Node2D) -> void:
	if vide == false:
		if rest <= 0:
...
func _on_area_banque_frappe_10_piasse_left_body_entered(_body: Node2D) -> void:
	if vide == false:
		if _body is player:
			kickable_left = true

func _on_area_banque_frappe_10_piasse_left_body_exited(_body: Node2D) -> void:
	kickable_left = false

func _on_area_banque_frappe_10_piasse_right_body_entered(_body: Node2D) -> void:
	if vide == false:
		if _body is player:
			kickable_right = true

func _on_area_banque_frappe_10_piasse_right_body_exited(_body: Node2D) -> void:
