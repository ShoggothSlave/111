...
func _on_area_20_piasse_body_entered(_body: Node2D) -> void:
	if vide == false:
		if _body is player:
...
func _on_area_frappe_20_piasse_left_body_entered(_body: Node2D) -> void:
	if vide == false:
		if _body is player:
			kickable_left = true

func _on_area_frappe_20_piasse_left_body_exited(_body: Node2D) -> void:
	kickable_left = false

func _on_area_frappe_20_piasse_right_body_entered(_body: Node2D) -> void:
	if vide == false:
		if _body is player:
			kickable_right = true

func _on_area_frappe_20_piasse_right_body_exited(_body: Node2D) -> void:
